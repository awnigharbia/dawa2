...
abstract class $LoginStateCopyWith<$Res> {
  ...
  $Res call({Phone phone, String phoneCode, FormzStatus status});
}
...
class _$_LoginState implements _LoginState {
  ...
  @override
  String toString() {
    return 'LoginState(phone: $phone, phoneCode: $phoneCode, status: $status)';
  }
...
abstract class _LoginState implements LoginState {
  const factory _LoginState(
      {Phone phone, String phoneCode, FormzStatus status}) = _$_LoginState;
