...
class _MaterialBottomNavigationScaffoldState
  ...
  final List<MaterialBottomNavigationTab> materialNavigationBarItems = [];
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        bottomNavigationBar: Container(
          height: Platform.isAndroid ? 70.0 : 90.0,
          ...
          child: BottomNavigationBar(
            ...
            selectedItemColor: ColorSchema.green,
  ...
  Widget _buildPageFlow(
    ...
    int tabIndex,
    MaterialBottomNavigationTab item,
  ) {
